	...
	<section class="topBottom">
		...
		<section class="navigation">
			<ul>
				...
				<li><a href="implimentation.php" class="active"><span>Implimentation</span></a></li>
		...
		<section class="row">
			<section class="col s12 m6 l8 leftSide">
				<section class="headerText">
					<div class="line"></div>
					<div class="title">Action plans</div>
				</section>
				<section class="mainText">
					<p>Georgia continued its economic progress since, "moving from a near-failed state in 2003 to a relatively well-functioning market economy in 2014".[19] In 2007, the World Bank named Georgia the World's number one economic reformer.</p>
				</section>
				...
				<section class="headerText marginTop40">
					<div class="line"></div>
					<div class="title">Strategic Documents</div>
				</section>
				<ul class="collapsible" data-collapsible="accordion">
					<li>
						<div class="collapsible-header"><i class="blueArraw-icon marginTop14"></i><span>Customs and Trade Facilitation</span></div>
						<div class="collapsible-body">
								<div class="hideShadow"></div>
								<section class="fileTree">
									<ul>
