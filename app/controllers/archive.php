...
class Archive extends Controller
{
	...
	public function index($name = '', $type = '', $date_format = '')
	{
		/* DATABASE */
		...
		$db_selectArchive = new Database("modules", array(
			"method"=>"selectArchive", 
		...
		// archive
		$archive = $this->model('_archive');
		$archive->data = $db_selectArchive->getter(); 
		$archive->type = $type; 
